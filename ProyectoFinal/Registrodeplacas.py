...
def ventanaPlacas():
    ventanaplacas = tk.Tk()
    ventanaplacas.title ("Registro de placas")
    ventanaplacas.geometry ("1800x850+0+0")
    user = tk.StringVar(ventanaplacas)
    tk.Label(ventanaplacas, text = "Nombre:").place(x=60,y=40)
    caja1 = tk.Entry(ventanaplacas, width=100, textvariable=user).place(x=60,y=80)


    direccion = tk.StringVar(ventanaplacas)
    tk.Label(ventanaplacas, text = "Direccion").place(x=60,y=120)
    caja2 = tk.Entry(ventanaplacas, width=100, textvariable=direccion).place(x=60,y=160)


    mail = tk.StringVar(ventanaplacas)
    tk.Label(ventanaplacas, text = "Correo:").place(x=60,y=200)
    caja3 = tk.Entry(ventanaplacas,width=100, textvariable=mail).place(x=60,y=240)
